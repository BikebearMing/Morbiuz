      ...
      <section className="about-our-team">
        <div className="wrapper">
          <div className="top">
            ...
            <h1 className="h1 orange">MEET THE <br />TEAM</h1>
          </div>
